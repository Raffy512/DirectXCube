...
bool LoadContent()
{
    ...
    // Load the shaders
    //d3dVertexShader = LoadShader<ID3D11VertexShader>( L"../data/shaders/SimpleVertexShader.hlsl", "SimpleVertexShader", "latest" );
    //d3dPixelShader = LoadShader<ID3D11PixelShader>( L"../data/shaders/SimplePixelShader.hlsl", "SimplePixelShader", "latest" );
...
void UnloadContent()
{
    SafeRelease(d3dConstantBuffers[CB_Appliation]);
